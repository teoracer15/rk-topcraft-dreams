...
export const PROJECTS: CurrentProject[] = [
  ...
  },
  {
    ...
    gallery: [
      ...
      { src: paloma01.url, label: "La Paloma — exterior view 02" },
      { src: paloma02.url, label: "La Paloma — exterior view 03" },
      { src: paloma03.url, label: "La Paloma — exterior view 04" },
      { src: paloma04.url, label: "La Paloma — exterior view 05" },
      { src: paloma05.url, label: "La Paloma — exterior view 06" },
      { src: paloma06.url, label: "La Paloma — exterior view 07" },
      { src: paloma07.url, label: "La Paloma — exterior view 08" },
      { src: paloma08.url, label: "La Paloma — exterior view 09" },
      { src: paloma09.url, label: "La Paloma — exterior view 10" },
      { src: paloma10.url, label: "La Paloma — exterior view 11" },
      { src: paloma11.url, label: "La Paloma — exterior view 12" },
      { src: paloma12.url, label: "La Paloma — exterior view 13" },
      { src: paloma13.url, label: "La Paloma — exterior view 14" },
      { src: paloma14.url, label: "La Paloma — exterior view 15" },
      { src: paloma15.url, label: "La Paloma — exterior view 16" },
      { src: paloma16.url, label: "La Paloma — exterior view 17" },
      { src: paloma17.url, label: "La Paloma — exterior view 18" },
      { src: paloma18.url, label: "La Paloma — exterior view 19" },
      { src: paloma19.url, label: "La Paloma — exterior view 20" },
      { src: paloma20.url, label: "La Paloma — exterior view 21" },
      { src: paloma22.url, label: "La Paloma — exterior view 22" },
      { src: paloma23.url, label: "La Paloma — exterior view 23" },
      { src: paloma24.url, label: "La Paloma — exterior view 24" },
      { src: paloma25.url, label: "La Paloma — exterior view 25" },
      { src: paloma26.url, label: "La Paloma — exterior view 26" },
      { src: paloma27.url, label: "La Paloma — exterior view 27" },
      ...
      { src: paloma32.url, label: "La Paloma — exterior view 31" },
      { src: paloma33.url, label: "La Paloma — exterior view 32" },
      { src: paloma36.url, label: "La Paloma — exterior view 33" },
      { src: paloma40.url, label: "La Paloma — exterior view 34" },
      { src: paloma43.url, label: "La Paloma — exterior view 35" },
    ],
  },
];
